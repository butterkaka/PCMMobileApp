 ...
 */
  constructor(public platform: Platform, statusBar: StatusBar, public app: App, public ble: BLE, 
    public pcmchannelservice: PCMChannelDataService, public alertCtrl: AlertController,public splashScreen: SplashScreen, 
     private idle: Idle) {
    platform.ready().then(() => {
